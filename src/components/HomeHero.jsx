...
const HomeHero = () => {
  ...
  return (
    <>
      <div className="">
        <div className="w-screen mt-[100px] flex pb-10 justify-center bg-white">
          <div className="flex flex-col gap-6 justify-center items-center">
            ...
            >
              Welcome to De.Qube, where creativity meets code. Our passionate
              team of developers, designers, and strategists collaborates
              seamlessly to turn visionary concepts into robust software
              solutions
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
